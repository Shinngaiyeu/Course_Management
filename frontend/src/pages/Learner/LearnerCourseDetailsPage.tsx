                        ...
                        <div key={lesson.id} className="flex flex-col border-t border-gray-100 first:border-t-0">
                          ...
                          {isActive && lesson.videoUrl && (
                            <div className="px-12 pb-4 bg-gray-50 border-t border-gray-100">
                              ...
                              {lesson.content && (
                                <p className="mt-4 text-sm text-gray-700 whitespace-pre-wrap">{lesson.content}</p>
                              )}
                            </div>
                          )}

                          {isActive && !lesson.videoUrl && lesson.content && (
                            <div className="px-12 py-4 bg-gray-50 border-t border-gray-100 text-sm text-gray-700 whitespace-pre-wrap">
                              {lesson.content}
                            </div>
                          )}
                        </div>
